                        ...
                        <td align="center" colspan="4">
                            <table width="100%" cellpadd
                                ...
                                <tr height="20">
                                    ...
                                    <th width="3%" class="left_bt2">日上限</th>
                                    <th width="3%" class="left_bt2">月上限</th>
                                    <th width="3%" class="left_bt2">扣量</th>
                                    <th width="8%" class="left_bt2">屏蔽信息</th>
                                ...
                                <s:iterator value="list" id="bean">
                                    <tr class='t2'>
                                        ...
                                        <td><a href="cpnum!prlist.action?pageView.called=${bean.called}">${bean.reduce}%</a></td>
                                        <td>${bean.blackinfo}</td>
                                        <td>
